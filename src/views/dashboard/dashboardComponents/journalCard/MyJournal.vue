...
methods: {
  ...
  submitPost(){
    ...
    this.axios.post("https://dearme-prod-dearme-a7el1q.mo4.mogenius.io/postData", 
  ...
  deletePost(){
    this.axios.delete(`https://dearme-prod-dearme-a7el1q.mo4.mogenius.io/deleteData/${this.id}`,{
      headers: {
      'authorization': 'Bearer ' + localStorage.getItem("token")
    }})
      .then((response) => {
  ...
  getContentByDate(){
    this.axios.get("https://dearme-prod-dearme-a7el1q.mo4.mogenius.io/dataDate/" + this.currentDate(), {
      headers: {
      'authorization': 'Bearer ' + localStorage.getItem("token")
    }})
  .then(res => {
  ...
  updatePost(){
    this.axios.put(`https://dearme-prod-dearme-a7el1q.mo4.mogenius.io/updateData/${this.id}`,         
    QueryString.stringify({
      gridOne: this.gridOne, 
      gridTwo: this.gridTwo, 
      gridThree: this.gridThree, 
  ...
  changeDate(n = 0){
    ...
    this.axios.get("https://dearme-prod-dearme-a7el1q.mo4.mogenius.io/dataDate/" + this.date, {
      headers: {
      'authorization': 'Bearer ' + localStorage.getItem("token")
    }})
    .then(res => {
